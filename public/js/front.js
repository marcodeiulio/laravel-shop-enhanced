...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    filterList: function filterList() {
      ...
      var new_array = this.products.filter(function (product) {
        if (_this.brand_ids.includes(_this.selectedBrand)) {
          return true;
        } else return false;
      });
    ...
    getProducts: function getProducts() {
      ...
      axios.get("http://localhost:8000/api/products").then(function (res) {
        if (_this2.selectedBrand) {}
    ...
    getBrandsList: function getBrandsList() {
      ...
      axios.get("http://localhost:8000/api/brands").then(function (res) {
        _this3.brands = res.data;

        _this3.brands.forEach(function (brand) {
          _this3.brand_ids.push(brand["id"]);
        });
...
var render = function () {
  ...
  return _c("div", { staticClass: "container" }, [
    ...
    _c(
      "ul",
      _vm._l(_vm.filteredByBrands, function (product) {
...
var root = new Vue({
  el: '#root',
  render: function render(h) {
    return h(_components_Products_vue__WEBPACK_IMPORTED_MODULE_0__["default"]);
  }
});
...
module.exports = __webpack_require__(/*! /Users/reidar/Desktop/laravel-shop-master/resources/js/front.js */"./resources/js/front.js");
